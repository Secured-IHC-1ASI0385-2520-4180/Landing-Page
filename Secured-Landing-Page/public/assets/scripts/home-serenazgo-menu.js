// Script para manejar el menú responsive en home-serenazgo.html
document.addEventListener('DOMContentLoaded', function() {
  console.log('🚀 Iniciando script home-serenazgo-menu.js');
  ...
  // ===== MANEJO DEL MENÚ HORIZONTAL (HEADER) =====
  ...
  console.log('✨ Script home-serenazgo-menu.js cargado completamente');
});
